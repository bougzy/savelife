  ...
  return (
    <Container className="mt-4 text-center">
            ...
            <Row>
              <Col lg={6} className="offset-lg-3 animate__animated animate__fadeInUp">
                <Form className="p-3">
                  ...
                  <Button variant="dark" className="p-3 mt-3" onClick={handleShow}>
                    Make Donation
                  </Button>
                </Form>
              </Col>
          ...
          <Card.Body>
            <Row>
              <Col md={4} className="mb-3">
                <img
                  src="https://via.placeholder.com/150"
                  alt="Payment Method Placeholder"
                  className="img-fluid"
                />
              </Col>
              <Col md={4} className="mb-3">
      ...
      <Modal show={showModal} onHide={handleClose}>
        ...
        <Modal.Body>
          Thank you for choosing to donate. Please confirm your donation amount and details.
        </Modal.Body>
        <Modal.Footer>
